...
const Hero = () => {
  ...
  return (
    <div className="relative bg-slate-950 py-10  cursor-pointer overflow-hidden">

    
<Animate/>
      {/* Hero Content */}
      <div className="container mx-auto text-center mt-28  relative z-10">
        <h1
          data-aos="fade-up"
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-10 " >
          {TeamData.map((member) => (
            <div
              key={member.id}
              className="bg-violet-800 rounded-lg  overflow-hidden p-6 flex flex-col justify-between items-center transition-transform duration-300 min-h-[450px]"
              style={{boxShadow:' 4px 6px rgba(228, 228, 231, 0.5)'}}
            >
              {/* Image Section */}
              <div className="relative"   data-aos="fade-down"    data-aos-duration="1900"
          data-aos-once="true">
                <div className="h-40 w-40 sm:h-48 sm:w-48 rounded-full overflow-hidden border-4 border-slate-900  ">
                  <img
                    src={member.image}
                    alt={member.name}
              ...
              <div className="flex-1 flex flex-col items-center text-center">
                <h2 className="text-2xl font-bold text-gray-200 mt-6"  data-aos="fade-down" >
                  {member.name}
                </h2>
                <p className="text-slate-950 font-medium text-lg" data-aos="fade-up">
                  {member.role}
                </p>
                ...
                <br></br>
                <p className="text-gray-400 text-sm mt-2" data-aos="fade-right">
                  {member.description}
                </p>
              </div>
              {/* Button */}
              <a
                href={member.cvLink}
                download
                className="mt-4 inline-flex items-center justify-center px-6 py-3 bg-slate-950 text-gray-200 font-bold text-sm rounded-full shadow-md hover:bg-violet-800 transition duration-300"
              >
